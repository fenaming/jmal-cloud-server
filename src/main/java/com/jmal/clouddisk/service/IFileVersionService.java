...
public interface IFileVersionService {
     ...
     * @param userId userId
     */
    void saveFileVersion(String username, String relativePath, String userId, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<List<GridFSBO>>
     */
    ResponseResult<List<GridFSBO>> listFileVersionByPath(String path, Integer pageSize, Integer pageIndex, Boolean isTogether, String spaceFlag);
