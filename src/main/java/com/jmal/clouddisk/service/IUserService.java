...
public interface IUserService {
    ...
    String IS_TOGETHER = "isTogether";
    String SPACE_FLAG = "spaceFlag";
//    String IS_DESIGNER = "isDesigner";
//    String IS_MACHINE = "isMachine";
//    String IS_INSTALL = "isInstall";
//    String IS_CONTROL = "isControl";
//    String IS_ELECTRIC = "isElectric";
//    String IS_SAMPLE = "isSample";
