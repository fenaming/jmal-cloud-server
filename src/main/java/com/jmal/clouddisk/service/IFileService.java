...
public interface IFileService {
    ...
    FileDocument previewTextByPath(String path, String username, Boolean isTogether, String spaceFlag);
     ...
     * @return StreamingResponseBody
     */
    StreamingResponseBody previewTextByPathStream(String path, String username, Boolean isTogether, String spaceFlag);
     ...
     * @return String
     */
    String imgUpload(String baseUrl, String filepath, MultipartFile file, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> delete(String username, String currentDirectory, List<String> fileIds, String operator, Boolean isTogether, String spaceFlag);
     ...
     * @param fileIdList 文件id列表
     */
    void packageDownload(HttpServletRequest request, HttpServletResponse response, List<String> fileIdList, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> rename(String newFileName, String username, String id, String folder, Boolean isTogether, String spaceFlag);
     ...
     * @param file 文件/文件夹
     */
    void deleteFile(String username, File file, Boolean isTogether);
    void deleteFile(String username, File file, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> unzip(String fileId, String destFileId, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> listFiles(String path, String username, boolean tempDir, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> upperLevelList(String path, String username, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> delFile(String path, String username, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> renameByPath(String newFileName, String username, String path, Boolean isTogether, String spaceFlag);
     ...
     */
    ResponseResult<FileIntroVO> addFile(String fileName, Boolean isFolder, String username, String parentPath, String folder, Boolean isTogether, String spaceFlag);
     ...
     * @return ResponseResult<Object>
     */
    ResponseResult<Object> duplicate(String fileId, String newFilename, Boolean isTogether, String spaceFlag);
