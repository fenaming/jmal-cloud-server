...
public class FileProperties {
    ...
    /***
     * 共享空间目录名称 位于rootDir下,文件监控目录
     */
    private String togetherFileDir = "together";
    /***
     * 机械设计资料图库目录名称 位于rootDir下,文件监控目录
     */
    private String designerFileDir = "designer";
    /***
     * 设备图库目录名称 位于rootDir下,文件监控目录
     */
    private String machineFileDir = "machine";
    /***
     * 设备安装图库目录名称 位于rootDir下,文件监控目录
     */
    private String installFileDir = "install";
    /***
     * 设备控制程序库目录名称 位于rootDir下,文件监控目录
     */
    private String controlFileDir = "control";
    /***
     * 设备电路图库目录名称 位于rootDir下,文件监控目录
     */
    private String electricFileDir = "electric";
    /***
     * 共享文件夹试用库目录名称 位于rootDir下,文件监控目录
     */
    private String sampleFileDir = "sample";
    /**
    ...
    public String getTogetherFileDir() {
        return togetherFileDir;
    }

    public String getDesignerFileDir() {
        return designerFileDir;
    }

    public String getMachineFileDir() {
        return machineFileDir;
    }
    ...
    public String getElectricFileDir() {
        return electricFileDir;
    }

    public String getSampleFileDir() {
        return sampleFileDir;
    }
