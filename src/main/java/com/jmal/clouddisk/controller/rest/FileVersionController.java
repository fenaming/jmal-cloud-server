...
public class FileVersionController {
    ...
    @Permission("cloud:file:list")
    @LogOperatingFun(logType = LogOperation.Type.BROWSE)
    public ResponseResult<List<GridFSBO>> listByPath(@RequestParam String path, @RequestParam(required = false) Boolean isTogether, @RequestParam(required = false) String spaceFlag, @RequestParam Integer pageSize, @RequestParam Integer pageIndex) {
        return fileVersionService.listFileVersionByPath(path, pageSize, pageIndex, isTogether, spaceFlag);
    }
