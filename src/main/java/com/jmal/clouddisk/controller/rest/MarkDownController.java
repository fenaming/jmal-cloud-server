...
public class MarkDownController {
    ...
    public ResponseResult<Object> editTextByPath(@RequestBody UploadApiParamDTO upload) {
        ...
        if (Boolean.TRUE.equals(upload.getIsTogether())){
            prePth = Paths.get(fileProperties.getTogetherFileDir(), upload.getRelativePath());
        }else if (StringUtils.isNotEmpty(upload.getSpaceFlag())){
            prePth = Paths.get(upload.getSpaceFlag(), upload.getRelativePath());
        }else{
            prePth = Paths.get(upload.getUsername(), upload.getRelativePath());
        }
